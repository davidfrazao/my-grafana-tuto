...
CREATE USER IF NOT EXISTS 'grafana'@'%' IDENTIFIED BY 'grafanaPass';
ALTER USER 'grafana'@'%' IDENTIFIED BY 'grafanaPass';
...
```
mariadb -hmariadb -P3306 -ugrafana -pgrafanaPass -D logsim \
