...
* [ ] On the right top coner - choose the visualization: Histogram chart
  * [ ] Add the promsql: 
    ```
    rate(app_event_total{}[5m])
    ```
  * [ ] Legend: Visibility: Active
  * [ ] Standard options: Color schema : single + Yellow
