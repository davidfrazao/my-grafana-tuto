...
* [ ] On the right top coner - choose the visualization: stat
  * [ ] Add the promsql: 
    ```
    100 - (avg by (instance,mode) (rate(node_cpu_seconds_total{mode="idle"}[5m])) * 100)
    ```
  * [ ] Standard options: Unit: Percent (0-100)
  * [ ] Standard options: Display name: Ola
  * [ ] Standard options: Decimals: 1
  * [ ] Thresholds: RED = 50
  * [ ] Stat styles: Shoe percent change: active
  * [ ] Value option: Calculation: Last*
* [ ] Panel options - Title: 05-01-03-Time-series-Gauge
